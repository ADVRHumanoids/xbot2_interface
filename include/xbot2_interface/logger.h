...
inline namespace v2 {
    ...
    /* Modifiers */
    XBOT2IFC_API std::ostream& bold_on(std::ostream& os);

    XBOT2IFC_API std::ostream& bold_off(std::ostream& os);
    
    XBOT2IFC_API std::ostream& color_green(std::ostream& os);
    
    XBOT2IFC_API std::ostream& color_red(std::ostream& os);
    
    XBOT2IFC_API std::ostream& color_yellow(std::ostream& os);
    
    XBOT2IFC_API std::ostream& color_reset(std::ostream& os);
     ...
     * 
     */
    class XBOT2IFC_API Endl {
        
    public:
        
        friend class LoggerClass;
        
        friend XBOT2IFC_API void operator<< ( std::ostream& os, Endl& endl );
     ...
     * 
     */
    class XBOT2IFC_API LoggerClass {
